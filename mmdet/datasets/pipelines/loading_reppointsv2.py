...
import cv2
import mmcv
import matplotlib.pyplot as plt #sh
...
class LoadRPDV2Annotations(object):
    ...
    def _load_semantic_map_from_box(self, results):
        ...
        #sh
        # feature_com=[]
        # for i_class in range(len(gt_sem_map)-1):
        #     feature_com.append(gt_sem_map[i_class])
        #     plt.axis('off')
        #     plt.imshow(gt_sem_map[i_class],cmap='gray')
        #     plt.savefig("/data1/shenhui/projects/mmdetection/configs/2021_06DIOR/2021_0608_class/{}.jpg".format(i_class))
        # plt.close()
        # feature_map_sum = sum(ele for ele in feature_com)
        # plt.imshow(feature_map_sum,cmap='gray')
        # plt.axis('off')
        # plt.savefig("/data1/shenhui/projects/mmdetection/configs/2021_06DIOR/2021_0608_class/all.jpg")
        # #end
        #
